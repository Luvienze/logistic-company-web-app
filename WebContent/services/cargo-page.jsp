        ...
        <div class="container col-xl-10 col-xxl-8 px-4 py-5">
            <div class="row align-items-center g-lg-5 py-5">
              <div class="col-lg-7 text-center text-lg-start">
                <h1 class="display-4 fw-bold lh-1 text-body-emphasis mb-3">Search Cargo</h1>
                <p class="col-lg-10 " style="font-size: small; font-weight: 400;" >
                    Track your shipment effortlessly! You can access the details of your queried shipment.
                     Our individual customers can easily track all their shipments automatically by becoming a member of SwiftShip Logistics' Online Portal.
                     Alternatively, they can download the SwiftShip Logistics Android / SwiftShip Logistics iPhone Applications based on their mobile devices. 
                     These apps not only provide automatic tracking for all shipments but also offer one-click access to services such as requesting a courier,
                     branch location search, price calculation, and communication—all with a 25% discount opportunity. Likewise, SwiftShip Logistics offers specialized
                     services to our corporate customers through the SwiftShip Logistics Corporate Online Portal.
              ...
              <div class="col-md-10 mx-auto col-lg-5">
                <form class="p-4 p-md-5 border rounded-3 bg-body-tertiary">
                  <div class="form-floating mb-3">
                    ...
                    <label for="floatingInput">Please enter your cargo id</label>
                  </div>
